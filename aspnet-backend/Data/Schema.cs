...
public static class Schema
{
    ...
    [
        ...
        CREATE TABLE IF NOT EXISTS "competitions" (
          ...
          "eligibility_dept" TEXT NOT NULL DEFAULT 'All Departments',
          "rules" TEXT,
          ...
          "created_at" TEXT NOT NULL DEFAULT to_char(now(), 'YYYY-MM-DD HH:MI:SS')
        );
        """,
        """
        ...
        CREATE TABLE IF NOT EXISTS "competition_team_members" (
          ...
          "joined_at" TEXT NOT NULL DEFAULT to_char(now(), 'YYYY-MM-DD HH:MI:SS')
        );
        """,
        """
        CREATE TABLE IF NOT EXISTS "competition_submissions" (
          ...
          "video_url" TEXT,
          "is_locked" BIGINT NOT NULL DEFAULT 0,
          "submitted_at" TEXT NOT NULL DEFAULT to_char(now(), 'YYYY-MM-DD HH:MI:SS')
        );
        """,
        """
        CREATE TABLE IF NOT EXISTS "competition_evaluations" (
          ...
          "remarks" TEXT,
          "evaluated_at" TEXT NOT NULL DEFAULT to_char(now(), 'YYYY-MM-DD HH:MI:SS')
        );
        """,
        """
        CREATE TABLE IF NOT EXISTS "competition_attendance" (
          ...
          "verified_by" TEXT NOT NULL DEFAULT 'System QR Gate'
        );
        """,
        """
        CREATE TABLE IF NOT EXISTS "competition_certificates" (
          ...
          "user_name" TEXT NOT NULL,
          "team_name" TEXT,
          "cert_type" TEXT NOT NULL DEFAULT 'participant',
          "cert_code" TEXT NOT NULL UNIQUE,
          "qr_payload" TEXT NOT NULL,
          "issued_at" TEXT NOT NULL DEFAULT to_char(now(), 'YYYY-MM-DD HH:MI:SS')
        );
        """,
    ];
}
