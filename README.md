...
VSCMS ERP (Dr. Virendra Swarup College of Management Studies) is an enterprise-grade college management system built with a decoupled architecture featuring a Next.js 16 frontend and an ASP.NET Core (.NET 10) backend.
